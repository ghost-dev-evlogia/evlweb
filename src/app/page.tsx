...
const marqueeItems = [
  "NeurIPS", "·", "Applied AI Research", "·", "ICML", "·",
  "Patent Strategy", "·", "ICLR", "·", "Foundation Models", "·",
  "AAAI", "·", "R&D Consulting", "·", "CVPR", "·",
  "AI Products", "·", "ECCV", "·", "Research Publications", "·",
];
    ...
    <>
      ...
      <main>
            ...
            <div className="marquee-track">
              {[...marqueeItems, ...marqueeItems].map((item, i) => (
                <span
                  ...
                  style={{
                    color: item === "·" ? "rgba(0,0,0,0.18)" : "rgba(0,0,0,0.32)",
                  }}
                >
                  {item}
                </span>
        ...
        <section className="px-6 py-14 md:py-20">
          <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <ScrollReveal key={label} delay={i * 80} variant="scale" className="h-full">
        ...
        <div className="max-w-5xl mx-auto px-6">
          <ScrollReveal><div className="divider" /></ScrollReveal>
        </div>
              ...
              {[
                ...
                <ScrollReveal key={title} delay={i * 80} className="h-full">
                  <div className="glass-card card-hover rounded-2xl p-7 md:p-9 relative overflow-hidden h-full">
                    <div className="font-sans text-black/18 text-[10px] tracking-widest mb-5">{num}</div>
                    <h3
                    ...
                    <p className="font-sans text-black/45 text-sm leading-relaxed">{desc}</p>
                  </div>
                </ScrollReveal>
              ))}
            </div>
              ...
              <div className="glass-card rounded-3xl p-8 md:p-16 relative overflow-hidden">
                <div className="relative">
                  ...
                  <p className="font-sans text-black/40 text-sm leading-relaxed max-w-lg mb-12 md:mb-16">
                    The gap between AI research and production is where most firms fail.
                    We operate across the full spectrum — from whiteboard to weight file
                    to patent to paper — so nothing gets lost in translation.
                  </p>

                  <div className="grid md:grid-cols-3 gap-8 md:gap-10">
                    {[
                      { step: "01", title: "Discover & Define", desc: "Deep problem scoping with your domain experts and research leads. We find the real constraint before writing a line of code." },
                      { step: "02", title: "Research & Build",  desc: "Rigorous R&D cycles with production-grade engineering running in parallel — not sequentially. Velocity without shortcuts." },
                      { step: "03", title: "Ship & Protect",   desc: "Deploy, file patents, publish the research. Your IP stays yours. Your competitive advantage stays yours." },
                      ...
                      <div key={step} className="relative">
                        ...
                        <h4 className="font-serif text-black/90 text-base md:text-lg mb-2">{title}</h4>
                        <p className="font-sans text-black/40 text-sm leading-relaxed">{desc}</p>
                        {i < 2 && (
                          <div
                            className="hidden md:block absolute top-8 -right-5 w-10 h-px"
                            style={{ background: "linear-gradient(90deg, rgba(0,0,0,0.08), transparent)" }}
                          />
                        )}
                      </div>
                    ))}
        ...
        <section id="research" className="px-6 py-16 md:py-28">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-3 md:gap-4">
              {[
                { label: "Publication Venues", value: "NeurIPS · ICML · ICLR · AAAI · CVPR", sub: "Peer-reviewed conference papers" },
                { label: "Patent Portfolio",   value: "US · EU · International",              sub: "Filed, pending & granted" },
                { label: "Research Domains",   value: "LLMs · Vision · Multimodal · Agents", sub: "Active research areas" },
                ...
                <ScrollReveal key={label} delay={i * 80} className="h-full">
                  <div className="glass-card card-hover rounded-2xl p-6 md:p-8 text-center h-full flex flex-col items-center justify-center gap-2.5">
                    <div className="font-sans text-black/30 text-[10px] tracking-[0.25em] uppercase">{label}</div>
                    <div className="font-serif text-black/80 text-sm md:text-base leading-snug">{value}</div>
                    <div className="font-sans text-black/30 text-[10px] tracking-wide">{sub}</div>
                  </div>
                </ScrollReveal>
              ))}
            </div>
            ...
            <ScrollReveal variant="scale">
              <div className="glass-card rounded-3xl p-10 md:p-20 text-center relative overflow-hidden">
                <div
                  ...
                  style={{ background: "radial-gradient(ellipse, rgba(0,0,0,0.03), transparent 70%)" }}
                />
                <div className="relative">
                  <p className="font-sans text-black/30 text-[10px] tracking-[0.3em] uppercase mb-4">
                    Ready to Begin
                  ...
                  <h2
                    ...
                    style={{ fontSize: "clamp(1.9rem, 5vw, 3.8rem)", letterSpacing: "-0.01em" }}
                  >
                  ...
                  <p className="font-sans text-black/40 text-sm leading-relaxed mb-10 max-w-sm mx-auto">
                    Bring us your hardest AI problem. We&apos;ll scope it, build it,
                    patent it — and if the science warrants it, publish it.
                  </p>
                  <a
      ...
      <footer className="border-t px-6 py-8" style={{ borderColor: "rgba(0,0,0,0.08)" }}>
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 font-sans text-black/30 text-xs">
            <span>© 2026</span>
            <a href="mailto:hello@evlogia.ai" className="hover:text-black/55 transition-colors duration-200">
              hello@evlogia.ai
            </a>
