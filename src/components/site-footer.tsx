        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 md:gap-6 mb-8 md:mb-10">
            ...
            <div className="shrink-0">
              <AsciiMotionLogo />
              <p className="font-sans text-black/70 text-[11px] tracking-[0.18em] uppercase mt-3">
            ...
            <div className="flex flex-col sm:flex-row gap-8 sm:gap-12 md:gap-14">
              ...
              <div className="flex flex-col gap-2.5">
                <p className="font-sans text-black/45 text-[10px] tracking-[0.2em] uppercase mb-0.5">Site</p>
                {siteLinks.map(({ label, href }) => (
                  <Link
                    key={label}
                    href={href}
                    className="font-sans text-black/70 text-[13px] hover:text-black transition-colors duration-200"
                  >
                    {label}
                  </Link>
                ))}
              ...
              {/* Contact */}
              <div className="flex flex-col gap-2.5">
                <p className="font-sans text-black/45 text-[10px] tracking-[0.2em] uppercase mb-0.5">Contact</p>
                <button
                  type="button"
                  ...
                  className="font-sans text-black/80 text-[13px] hover:text-black transition-colors duration-200 text-left cursor-pointer"
                >
                  Book a 30-min call
                </button>
                <a
              ...
              {/* Legal */}
              <div className="flex flex-col gap-2.5">
                <p className="font-sans text-black/45 text-[10px] tracking-[0.2em] uppercase mb-0.5">Legal</p>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
            <p className="font-sans text-black/55 text-[11px]">
            ...
            <div className="flex items-center gap-4 order-first sm:order-none">
              <a
                ...
                className="flex items-center text-black/45 hover:text-black/80 transition-colors duration-200"
              >
